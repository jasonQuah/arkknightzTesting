...
function RmqTable({ columns, data, setGenerateUrlDataItems }) {
    ...
    useEffect(() => {
        ...
        setGenerateUrlDataItems(selectedIds.map(x => data[x].itemid))
...
const RmqTotalMessagesTable = ({ jsonData, setGenerateUrlDataItems }) => {
    const columns = React.useMemo(
        () => [
            ...
            },
            {
                ...
                aggregate: SetCustomAggregateValue,
                Aggregated: ({ value }) => `${value} (total messages)`,
...
export default RmqTotalMessagesTable
